...
var EBE_AddressSelector = function(){
	...
	var selectEls = $(".m7p_contentMainPanel select");
...
var EBE_EditManager = function(){
	var formEl = $(".m7p_contentMainPanel form");
	...
	formEl.submit(function(){
		...
		for(i=0;i< inputEls.length;i++){
			...
			if( $.trim(inputEls.eq(i).val()) == "" ){
				result = false;
				borderEls.eq(i).addClass("m7p_validationFailed");
			}else{
				borderEls.eq(i).removeClass("m7p_validationFailed");
			}
		}
		return result;
	});
